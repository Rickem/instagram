...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    await uploadString(imageRef, selectedFile, "data_url").then(async snap => {
      ...
      >
        <div className="flex items-center justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          <Transition.Child
            ...
            >
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p06">
                <div className="">
                  {
                    selectedFile ? (
                      <img 
                ...
                <div className="mt-5 sm:mt-6">
                  <button type="button"
                    ...
                    focus:outline-none focus:ring focus:ring-offset-2 focus:ring-red-500 sm:text-sm disabled:bg-gray-300
